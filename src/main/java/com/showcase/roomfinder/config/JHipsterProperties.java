...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "roomfinder@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "roomfinder API";

        private String description = "roomfinder API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "roomfinder";
